<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="SelectOrder.aspx.cs" Inherits="Beeant.Presentation.Admin.Finance.Finance.Invoiceout.SelectOrder" %>
       ...
       <Columns>
        ...
        <asp:TemplateField ItemStyle-CssClass="center ckbox">
            ...
            <ItemTemplate>
                    ...
                    <input value='<%#Eval("OpenAmount") %>' id="hfOpenAmount" type="hidden" runat="server" SerializeName="OpenAmount" />
                    <input value='<%#Eval("InvoiceAmount") %>' id="hfPaidAmount" type="hidden" SerializeName="InvoiceAmount" />
